...
<section class="card">
  ...
  <div class="subpanel active" id="sub-maaling">
    ...
    <hr class="rule">
    <div class="eyebrow neutral">Måleforbehold · den store offentlige sektoren</div>
    <h3>~¼ av verdiskapingen har mekanisk null produktivitet — og sektoren er størst i Norge</h3>
    <p>Rundt <b>30 % av timeverkene</b> (og <b>~24 % av verdiskapingen</b>) ligger i offentlig forvaltning, der tjenestene ikke har markedspriser. Tradisjonelt måles offentlig produksjon som <b>kostnaden av innsatsen</b> (lønn + vareinnsats + kapitalslit) — «input = output». Da blir realveksten i teller (verdiskaping) ≈ realveksten i nevner (timer), og <b>målt produktivitetsvekst ≈ 0 per konstruksjon</b>. En lønnsøkning for sykepleiere løfter nominell verdiskaping, men input-deflatoren fjerner den igjen — ingen målt gevinst, og reelle kvalitetsforbedringer blir stort sett usynlige. Det samme gjelder TFP: Solow-residualen i offentlig sektor er i praksis antatt null.</p>
    <div class="grid2">
      <div class="box">
        <h4>Offentlig forvaltnings andel av Fastlands-BNP</h4>
        <table class="tbl" style="font-size:12.5px;margin:0">
          <thead><tr><th>År</th><th class="num">2005</th><th class="num">2014</th><th class="num">2024</th></tr></thead>
          <tbody><tr><td>Verdiskaping (andel)</td><td class="num">22,6 %</td><td class="num">23,3 %</td><td class="num">24,0 %</td></tr></tbody>
        </table>
        <p style="font-size:12px;margin:8px 0 0;color:var(--slate)">Sysselsettingsandelen er ~30 % — høyere enn verdiandelen fordi offentlig produksjon måles til kostnad, uten markup. Kilde: SSB 09189.</p>
      </div>
      <div class="box accent">
        <h4>Hvor stort utslag?</h4>
        <p style="font-size:13px;margin:0">Med ~24 % vekt på en sektor med ≈0 målt produktivitet: hvis offentlig sektors <i>sanne</i> produktivitet vokste ~1 %, er aggregert Fastlands-produktivitet <b>undervurdert med ~0,2–0,4 pp/år</b>. Stort, i en kontekst der hele nivået er ~1,2 %.</p>
      </div>
    </div>
    <div class="note"><b>Men det forklarer mest nivået, ikke fallet.</b> Null-produktivitets-draget fantes også i «gullalderen» — det er et nivå-fenomen. Andelen steg bare 22,6 → 24,0 % på 20 år (~0,07 pp/år), så reallokeringsdraget på selve vekstraten er forsvinnende lite per år. Måleeffekten gjør altså at <b>nivået ser verre ut enn virkeligheten</b> og at land-sammenligninger blir misvisende (Norge har OECDs største offentlige sektor) — men den skaper ikke i seg selv fallet etter 2015.</div>

    <div class="eyebrow neutral" style="margin-top:18px">Baumols kostnadssykdom · den reelle siden av samme mynt</div>
    <div class="grid2">
      <div class="box">
        <h4>Hva Baumol-effekten er</h4>
        <p style="font-size:13px;margin:0">William Baumol (1966): i arbeidsintensive tjenester — omsorg, undervisning, scenekunst — er det <b>iboende vanskelig å øke produktiviteten</b>. En sykepleier eller lærer kan ikke betjene dobbelt så mange uten kvalitetstap. Men lønningene må følge resten av økonomien, ellers forsvinner arbeidskraften. Resultatet: <b>enhetskostnaden i tjenestene stiger relativt</b>, og når økonomien over tid flytter timer fra høyproduktiv industri til slike tjenester, <b>faller den aggregerte produktivitetsveksten — uten at noe «sløses bort».</b></p>
      </div>
      <div class="box">
        <h4>Måling vs. realitet</h4>
        <p style="font-size:13px;margin:0">To ulike krefter trekker aggregatet ned: (1) <b>måling</b> — offentlig output ≈ input gir kunstig null; (2) <b>Baumol</b> — en <i>reell</i>, velferdsrelevant strukturendring. Etter ESA 2010 bruker SSB delvis <b>volumindikatorer</b> for helse og utdanning (behandlinger, elevtall), så målt offentlig produktivitet er ikke strengt null — men kvalitetsjustering er svak og administrasjon fortsatt input-basert. Biasen er derfor mindre enn lærebok-ytterpunktet, og usikker i fortegn.</p>
      </div>
    </div>

    <div class="flag"><b>Konsekvensen for debatten.</b> Robuste produktivitetsvurderinger ser derfor på <b>markedssektoren</b> («Fastlands-Norge utenom offentlig forvaltning», ~76 % av verdiskapingen — SSB publiserer den) for å fjerne måleproblemet. Det er presis <b>Holms måle-kritikk</b> i tall: når ~¼ av verdiskapingen har mekanisk null TFP, er aggregert TFP en skjør størrelse å bygge en «gullalder vs. forfall»-fortelling på. Samtidig er Baumol-effekten reell og finanspolitisk relevant — det er nettopp den <span class="mb cge">DEMEC</span> og Perspektivmeldingen modellerer: aldring → mer ressurser til lavmålt-produktiv omsorg → press på bærekraften.</div>
  </div>
